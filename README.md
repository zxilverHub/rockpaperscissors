...
- **Bonus**:!does not added yet! Play Rock, Paper, Scissors, Lizard, Spock against the computer _(optional)_
...
I would like to add the bunos challenge version of this in my next solution for this challenge.
